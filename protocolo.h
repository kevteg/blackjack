    ...
    static QByteArray generateJson(int codigo, QVector<QVariant> *info ){
           ...
           QJsonDocument trama;
            ...
            case cod_aceptacion:
                ...
                info_s["aceptado"]    = info->at(0).toBool();//(info->at(0).toBool())?"true":"false";
                info_s["direccion"]   = info->at(1).toString();
                info_s["id"]          = info->at(2).toInt();//QString::number(info->at(2).toInt());
                break;
            ...
            case cod_comienzo_ronda:{
                ...
                for(QVector <QVariant>::iterator variable = info->begin(); variable != info->end(); variable++){
                    ...
                    if(!i)
                        arreglo_interno["id"]  = variable->toInt();//variable->toString();
                    else
            ...
            case cod_bono:
                ...
                info_s["bono"]        = info->at(1).toBool();//info->at(1).toBool()?"true":"false";
                break;
            ...
            case cod_respuesta_carta:
                ...
                info_s["jugar"]       = info->at(0).toBool();//info->at(0).toBool()?"true":"false";
                break;
            ...
            case cod_final_juego:{
                ...
                info_s["rondas"]            = info->at(0).toInt();//QString::number(info->at(0).toInt());
                info_s["cartas_jugadas"]    = info->at(1).toInt();//QString::number(info->at(1).toInt());
                info_s["desempate"]         = info->at(2).toBool();//info->at(2).toBool()?"true":"false";
                QJsonObject arreglo_interno;
                QJsonArray puntaje;
                int i = 0;
                for(int _var = 3; _var < info->count(); _var++) {
                    for (int var = 0; var < arreglo_interno.count() && !i; ++var)
                        arreglo_interno.remove((!var)?"id":"puntaje");
                    if(!i)
                        arreglo_interno["id"]  = info->at(_var).toInt();//info->at(_var).toString();
                    else
                        arreglo_interno["puntaje"] = info->at(_var).toInt();//QString::number(info->at(_var).toInt());
                    i++;
                    if(i == 2){
                        puntaje.append(arreglo_interno);
                        i = 0;
        ...
        if(trama.isObject()){
            vector_datos = new QVector<QVariant>;
             ...
             case cod_saludo:
                 ...
                 vector_datos->append( (!trama.object()["tiempo"].toInt())?(trama.object()["tiempo"].toString().toInt()):(trama.object()["tiempo"].toInt()) );
                 vector_datos->append((!trama.object()["espacios"].toInt())?(trama.object()["espacios"].toString().toInt()):(trama.object()["espacios"].toInt()));
                 break;
             case cod_solicitud:
             ...
             case cod_aceptacion:
                 ...
                 vector_datos->append((!trama.object()["aceptado"].toBool())?(((trama.object()["aceptado"].toString() == "true")?true:false)):true);
                 vector_datos->append(trama.object()["direccion"].toString());
                 vector_datos->append((!trama.object()["id"].toInt())?(trama.object()["id"].toString().toInt()):(trama.object()["id"].toInt()));
                 break;
             case cod_presentacion:{
             ...
             case cod_bono:
                 ...
                 vector_datos->append((!trama.object()["id"].toInt())?(trama.object()["id"].toString().toInt()):(trama.object()["id"].toInt()));
                 vector_datos->append((!trama.object()["bono"].toBool())?(((trama.object()["bono"].toString() == "true")?true:false)):true);
                 break;
             case cod_ofrecer_carta:
             ...
             case cod_respuesta_carta:
                 ...
                 vector_datos->append((!trama.object()["jugar"].toBool())?(((trama.object()["jugar"].toString() == "true")?true:false)):true);
                 break;
             ...
             case cod_final_juego:{
                 ...
                 vector_datos->append((!trama.object()["rondas"].toInt())?(trama.object()["rondas"].toString().toInt()):(trama.object()["rondas"].toInt()));
                 vector_datos->append((!trama.object()["cartas_jugadas"].toInt())?(trama.object()["cartas_jugadas"].toString().toInt()):(trama.object()["cartas_jugadas"].toInt()));
                 vector_datos->append(((!trama.object()["desempate"].toBool())?(((trama.object()["desempate"].toString() == "true")?true:false)):true));
                 QJsonArray arreglo_interno;
                 arreglo_interno = trama.object()["puntaje"].toArray();
                 for(int var = 0; var < arreglo_interno.size(); var++){
                     QJsonObject obj = arreglo_interno[var].toObject();
